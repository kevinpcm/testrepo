$templateFile       = 'C:\scripts\git\Azure\RMS\PaloAlto\azure\vmseries-simple-template\azureDeploy4.json'
...
New-AzureRmResourceGroupDeployment -Name PaloAltoTest2 -ResourceGroupName GORG -TemplateFile $templateFile `
         ...
         -baseurl "https://raw.githubusercontent.com/PaloAltoNetworks/azure/master/vmseries-simple-template" `
         -adminUserName "install" `
         -adminPassword $secureString `
         -authenticationType "password" `
         -srcIPInboundNSG "10.33.1.200" `
         -dnsNameForPublicIP "paloaltodns4"
