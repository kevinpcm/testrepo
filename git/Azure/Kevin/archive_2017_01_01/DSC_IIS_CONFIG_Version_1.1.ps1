...
dsc -ConfigurationData $ConfigData -DomCred $DomCred
            
# Make sure that LCM is set to continue configuration after reboot            
Write-Output "Set-DSCLocalConfigurationManager -Path c:\users\administrator\documents\dsc -Verbose -Force"
Set-DSCLocalConfigurationManager -Path c:\users\administrator\documents\dsc -Verbose -Force         
Write-Output "Set-DSCLocalConfigurationManager complete"            
# Build the domain
Write-Output "Start-DscConfiguration -Wait -Force  -Path c:\users\administrator\documents\dsc -Verbose"           
Start-DscConfiguration -Wait -Force  -Path c:\users\administrator\documents\dsc -Verbose
Write-Output "Start-DscConfiguration complete"