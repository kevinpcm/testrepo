...
if ($csvData -ne $null) {
    ...
    foreach ($row in $csvData) {
        ...
        $ipName         = "$vmName"+"pip1"
            ...
            $nic = New-AzureRmNetworkInterface -Name $nicName -ResourceGroupName $rgName -Location $Location -SubnetId $subnet -PublicIpAddressId $pip.Id -PrivateIpAddress $privIP -DnsServer "10.20.
